...
**GCC** - GNU C Compiler for compiling C code generated by Lex
```bash
sudo apt install gcc
```

**Flex** - Fast lexical analyzer generator for tokenizing input
```bash
...
**For files requiring input file argument:**
```bash
flex file.l
gcc lex.yy.c -o output
./output input.txt
